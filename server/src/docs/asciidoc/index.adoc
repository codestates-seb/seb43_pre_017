...
=== 질문글에 대한 평가 삭제
.curl-request
include::{snippets}/delete-evaluationArticle/curl-request.adoc[]

.path-parameters
include::{snippets}/delete-evaluationArticle/path-parameters.adoc[]

.http-request
include::{snippets}/delete-evaluationArticle/http-request.adoc[]

.http-response
include::{snippets}/delete-evaluationArticle/http-response.adoc[]

.response-fields
include::{snippets}/delete-evaluationArticle/response-fields.adoc[]
...
=== 답변글에 대한 평가 삭제
.curl-request
include::{snippets}/delete-evaluationAnswer/curl-request.adoc[]

.path-parameters
include::{snippets}/delete-evaluationAnswer/path-parameters.adoc[]

.http-request
include::{snippets}/delete-evaluationAnswer/http-request.adoc[]

.http-response
include::{snippets}/delete-evaluationAnswer/http-response.adoc[]

.response-fields
include::{snippets}/delete-evaluationAnswer/response-fields.adoc[]
