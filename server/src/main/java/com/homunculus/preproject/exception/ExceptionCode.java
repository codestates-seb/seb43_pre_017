...
public enum ExceptionCode {
    ...
    ANSWER_NOT_ACCEPTABLE(406, "Answer is not linked to Article"),

    COMMENT_MEMBER_NOT_ALLOWED(403, "Comment is not authored by the corresponding Member"),
    COMMENT_NOT_FOUND(404, "Comment not found"),
    COMMENT_ARTICLE_NOT_ACCEPTABLE(406, "Comment is not linked to Article"),
    COMMENT_ANSWER_NOT_ACCEPTABLE(406, "Comment is not linked to Answer"),
    ...
    EVALUATION_ARTICLE_NOT_ACCEPTABLE(406, "Evaluation is not linked to Article"),
    EVALUATION_ANSWER_NOT_ACCEPTABLE(406, "Evaluation is not linked to Answer"),
